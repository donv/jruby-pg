...
For documentation please refer to the MRI pg gem docs which you can
...
{<img src="https://travis-ci.org/donv/jruby-pg.png?branch=master" alt="Build Status" />}[https://travis-ci.org/donv/jruby-pg]
